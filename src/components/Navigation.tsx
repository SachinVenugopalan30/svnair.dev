    ...
    >
      ...
      >
        <div className="flex justify-between items-center px-4 py-4">
          {/* Logo */}
          <div className="flex items-center overflow-visible flex-shrink-0 min-w-[240px] sm:min-w-[280px] md:min-w-[300px]">
            <a
              href="/"
          ...
          <div className="md:hidden">
            <button
              ...
              className="w-12 h-12 flex items-center justify-center hover:text-scarlet focus:outline-none focus:ring-2 focus:ring-scarlet/50 transition-all duration-300 bg-transparent border-none p-0"
              style={{
                color: "#EFF6E0",
          ...
          <div className="space-y-2">
            {navItems.map((item, index) => (
              <a
                ...
                href={item.path}
                onClick={(e) => handleNavClick(e, item.path)}
                className="block px-6 py-4 rounded-2xl text-base font-medium transition-all duration-300 hover:text-white bg-raisin-black/60 hover:bg-gradient-to-r hover:from-scarlet/90 hover:to-scarlet border border-ivory/20 hover:border-scarlet/40 hover:shadow-lg hover:shadow-scarlet/20"
